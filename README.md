...
To enable automated deployments, navigate to **Settings ➡️ Secrets and variables ➡️ Actions** in your GitHub repository and add the following repository secrets:
